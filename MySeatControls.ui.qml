...
Rectangle {
    ...
    property string dayIcon: driverSeat ? "Day/Day_Seatdriver_48.png" : "Day/Day_Seatpassenger_48.png"
    property string nightIcon: driverSeat ? "Night/Night_Seatdriver_48.png" : "Night/Night_Seatpassenger_48.png"
    property string heatIconDay: driverSeat ? "Day/Day_Seatwarmerdriver_48.png" : "Day/Day_Seatwarmerpassenger_48.png"
    property string heatIconNight: driverSeat ? "Night/Night_Seatwarmerdriver_48.png" : "Night/Night_Seatwarmerpassenger_48.png"
    property real seatOffset: driverSeat ? 470 : 760
    property bool driverheater: driverSeat ? DData.heaterOnDriver : DData.heaterOnPassenger
    ...
    Image {
        ...
        x: seatOffset
        y: 34
        source: !heaterOnDrivercheckBox.checked ? (hvacmain.globalDaymode ? dayIcon : nightIcon) : (hvacmain.globalDaymode ? heatIconDay : heatIconNight)
    ...
    Text {
        ...
        width: 53
        height: 27
        text: localeInfo.toCorrectUnit(
                  driverSeat ? hvacmain.tempDriverseat : hvacmain.tempPassengerseat) + "°"
        font.pixelSize: 30
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Image {
                    ...
                    opacity: driverSeat ? (hvacmain.heaterOnDriver ? 1.0 : 0.6) : (hvacmain.heaterOnPassenger ? 1.0 : 0.6)
    ...
    CheckBox {
        ...
        onCheckedChanged: driverSeat ? (DData.heaterOnDriver = heaterOnDrivercheckBox.checked ? 1 : 0) : (DData.heaterOnPassenger = heaterOnDrivercheckBox.checked ? 1 : 0)
        Connections {
