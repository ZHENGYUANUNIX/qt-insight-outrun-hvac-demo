...
set_target_properties(Qt6::FlowView PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/libQt6FlowView.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "Qt6::Qml;Qt6::Core"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/Qt6FlowView.dll"
  )

list(APPEND _cmake_import_check_targets Qt6::FlowView )
list(APPEND _cmake_import_check_files_for_Qt6::FlowView "${_IMPORT_PREFIX}/lib/libQt6FlowView.a" "${_IMPORT_PREFIX}/bin/Qt6FlowView.dll" )
