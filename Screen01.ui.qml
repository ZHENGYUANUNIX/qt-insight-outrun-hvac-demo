...
Rectangle {
    ...
    Connections {
        function onStateChanged() {
            InsightTracker.sendScreenView(hvacmain.state)
        }
    }
    ...
    property bool globalDaymode: false
    ...
    MyParticle_check_control {
        ...
        onCheckBoxCheckedChanged: !checkBoxChecked ? DData.fanDirectionDriver |= DData.FanDirection.FACE_DIRECTION : DData.fanDirectionDriver &= (DData.FanDirection.FAN_DIRECTION_MASK ^ DData.FanDirection.FACE_DIRECTION)
    ...
    MyParticle_check_control {
        ...
        onCheckBoxCheckedChanged: !checkBoxChecked ? DData.fanDirectionDriver |= DData.FanDirection.FLOOR_DIRECTION : DData.fanDirectionDriver &= (DData.FanDirection.FAN_DIRECTION_MASK ^ DData.FanDirection.FLOOR_DIRECTION)
    ...
    MyParticle_check_control {
        ...
        onCheckBoxCheckedChanged: !checkBoxChecked ? DData.fanDirectionPassenger |= DData.FanDirection.FACE_DIRECTION : DData.fanDirectionPassenger &= (DData.FanDirection.FAN_DIRECTION_MASK ^ DData.FanDirection.FACE_DIRECTION)
    ...
    MyParticle_check_control {
        ...
        onCheckBoxCheckedChanged: !checkBoxChecked ? DData.fanDirectionPassenger |= DData.FanDirection.FLOOR_DIRECTION : DData.fanDirectionPassenger &= (DData.FanDirection.FAN_DIRECTION_MASK ^ DData.FanDirection.FLOOR_DIRECTION)
    ...
    MyParticle_center_control {
        ...
        x: 742
        y: 338
        checkBoxChecked: (hvacmain.fanDirectionPassenger
                          & DData.FanDirection.DEFROST_DIRECTION) !== 0
        onCheckBoxCheckedChanged: checkBoxChecked ? DData.fanDirectionPassenger |= DData.FanDirection.DEFROST_DIRECTION : DData.fanDirectionPassenger &= (DData.FanDirection.FAN_DIRECTION_MASK ^ DData.FanDirection.DEFROST_DIRECTION)
    ...
    MyParticle_center_control {
        ...
        onCheckBoxCheckedChanged: checkBoxChecked ? DData.fanDirectionDriver |= DData.FanDirection.DEFROST_DIRECTION : DData.fanDirectionDriver &= (DData.FanDirection.FAN_DIRECTION_MASK ^ DData.FanDirection.DEFROST_DIRECTION)
            ...
            CheckBox {
                ...
                Connections {
                    function onCheckStateChanged() {
                        ...
                        controlBar.heateroverridedriver = checkBox.checked
                    }
                }
            }
            ...
            CheckBox {
                ...
                Connections {
                    function onCheckStateChanged() {
                        ...
                        controlBar.heateroverridepassenger = checkBox1.checked
                    }
                }
            }
